...
- [Best Practices](https://support.optisigns.com#BestPractices)
- [The Troubleshooting Option](https://support.optisigns.com#TroubleshootingOption)
- [Hardware Troubleshooting](https://support.optisigns.com#Hardware)
  - [Network Troubleshooting](https://support.optisigns.com#Network)
  - [Power, HDMI & TV Connection Troubleshooting](https://support.optisigns.com#Connection)
  - [Blank Screen Troubleshooting](https://support.optisigns.com#BlankScreen)
  - [Fixing the OnHold Warning](https://support.optisigns.com#OnHold)
  - [App Freezes, Video Assets not Playing full video or Asset Not Loaded Fully](https://support.optisigns.com#AppFreezes)
  - [How to Factory Reset the OptiSigns Pro/ProMax Player](https://support.optisigns.com#FactoryReset)
- [Security Settings Troubleshooting](https://support.optisigns.com#SecuritySettings)
  - [Using the Device Log](https://support.optisigns.com#DeviceLog)
  - [Static IP](https://support.optisigns.com#StaticIP)
  - [Internal Websites and Root Certificates](https://support.optisigns.com#InternalWebsite)
- [Pro/ProMax Player RMA Process](https://support.optisigns.com#RMAProcess)
...
The first stop should be the [**Troubleshooting Page**](https://support.optisigns.com#TroubleshootingOption). The upper left box details network status. If all the text is green, this means there are no network issues. Any red text will require further troubleshooting.
...
- After trying to connect with these methods, [**Factory Reset**](https://support.optisigns.com#FactoryReset) the device, then perform initial setup again.
- If the device still cannot connect to any network, [**contact our support team**](https://support.optisigns.com/hc/en-us/articles/35626165056787-How-to-Contact-OptiSigns-Support). After a bit of troubleshooting, you may be asked to submit an [**RMA request**](https://support.optisigns.com#RMAProcess)**.**
...
If the device is still not displaying content after you’ve checked these try a [**Factory Reset**](https://support.optisigns.com#FactoryReset).
