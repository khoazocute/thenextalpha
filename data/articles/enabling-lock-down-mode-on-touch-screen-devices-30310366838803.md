...
- [What Lock Down Mode Does](https://support.optisigns.com#Lock)
- [How to Turn On Lock Down Mode](https://support.optisigns.com#On)
- [How to Turn Off Lock Down Mode](https://support.optisigns.com#Off)
  - [In the OptiSigns Portal](https://support.optisigns.com#Portal)
  - [On the Device Level](https://support.optisigns.com#Device)
- [Lock Down Mode by Device](https://support.optisigns.com#modebydevice)
  - [OptiSigns Android Player](https://support.optisigns.com#androidplayer)
  - [Windows](https://support.optisigns.com#windows)
  - [Android Tablets](https://support.optisigns.com#androidtablet)
  - [OptiSigns Pro Player (Gen 2)](https://support.optisigns.com#proplayer)
  - [iPad and Other iOS Devices](https://support.optisigns.com#ios)
...
| --- |
| **NOTE** |
| The following instructions will only need to be followed if your Pro Player looks like the one below. Otherwise, follow [these instructions](https://support.optisigns.com#androidplayer). |
