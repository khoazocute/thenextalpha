...
- [Prerequisites](https://support.optisigns.com#Prerequisites)
- [Configure the Source within Teams Rooms Pro Management Portal and OptiSigns Web Player](https://support.optisigns.com#Configure)
- [Send to a Teams Rooms Device](https://support.optisigns.com#Send)
- [Set Up the Virtual Screen App (ALTERNATE METHOD)](https://support.optisigns.com#SetUp)
