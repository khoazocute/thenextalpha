...
- [What’s Needed?](https://support.optisigns.com#Needed)
- [Video Wall Capabilities](https://support.optisigns.com#Capabilities)
  - [Video Wall Orientations and Pixel Sizes](https://support.optisigns.com#OrientationsPixel)
- [Purchasing a Video Wall Add-On](https://support.optisigns.com#Purchasing)
- [Setting Up a Video Wall App](https://support.optisigns.com#Setting)
  - [Creating a Basic Video Wall](https://support.optisigns.com#Creating)
  - [Merging Screens to Create a Continuous Image or Video](https://support.optisigns.com#Merging)
  - [Creating Custom Resolutions](https://support.optisigns.com#CustomResolutions)
  - [Forcing Rotation to Portrait or Landscape](https://support.optisigns.com#Forcing)
- [Setting Up the OptiSigns Pro Player](https://support.optisigns.com#ProPlayerSetup)
  - [Sync Playing Multiple Pro Players for Larger Video Walls](https://support.optisigns.com#SyncPlaying)
- [Makeshift Video Walls](https://support.optisigns.com#Makeshift)
  - [Using a Player with Multiple Video Outputs - Windows, Linux, Raspberry Pi](https://support.optisigns.com#MultipleVideo)
    - [Option 1: Dragging the App to Fill Up All Screens](https://support.optisigns.com#Dragging)
    - [Option 2: Fix the Screen Size Using the Override Win Size and Position Option (Recommended)](https://support.optisigns.com#PositionOption)
  - [Using a Video Wall Controller Distributor](https://support.optisigns.com#Controller)
