...
**Some of my Webex devices are missing from the list.** This is usually expected — OptiSigns lists your Webex room systems, not accessories like touch panels, monitors, or phones, and not devices running in Microsoft Teams Rooms mode. See [Which Webex devices appear in OptiSigns](https://support.optisigns.com#which-webex-devices-appear-in-optisigns) for the full breakdown.
