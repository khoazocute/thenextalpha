...
- [Identify Your Device](https://support.optisigns.com#Identify)
- [Best Practices](https://support.optisigns.com#BestPractices)
- [The Troubleshooting Option](https://support.optisigns.com#Troubleshooting)
- [Hardware Troubleshooting](https://support.optisigns.com#Hardware)
  - [Network Troubleshooting](https://support.optisigns.com#Network)
  - [Power Troubleshooting](https://support.optisigns.com#Power)
  - [HDMI & TV Connection Troubleshooting](https://support.optisigns.com#HDMI)
  - [Remote Control Troubleshooting](https://support.optisigns.com#RemoteControl)
  - [Changing Device Time Zone](https://support.optisigns.com#TimeZone)
  - [Blank Screen Troubleshooting](https://support.optisigns.com#BlankScreen)
  - [How to Factory Reset the OptiStick Player](https://support.optisigns.com#FactoryReset)
- [Content Playback Troubleshooting](https://support.optisigns.com#ContentPlayback)
  - [Website display or sizing issues](https://support.optisigns.com#WebsiteDisplay)
  - [Designer or template sizing issues](https://support.optisigns.com#DesignerSizing)
  - [Screen color distortion](https://support.optisigns.com#ScreenColor)
  - [Fixing the OnHold warning](https://support.optisigns.com#OnHold)
  - [App crashing](https://support.optisigns.com#AppCrashing)
- [OptiStick Player RMA Process](https://support.optisigns.com#RMA)
...
Functionally, these are quite similar. Both use the latest versions of the OptiSigns software. Most of their differences lie in [**Networking**](https://support.optisigns.com#Network)**.**
...
- Network issues, [**see above**](https://support.optisigns.com#Network).
...
If the device is still not displaying content after you’ve checked these, check our [**Content Playback Troubleshooting**](https://support.optisigns.com#ContentPlayback) section, then try a **Factory Reset**.
