...
- [How to Integrate POS Systems Through API Requests](https://support.optisigns.com#Section%201)  
  - [Get API URL Endpoint and Set Up API Request DataSource](https://support.optisigns.com#Section%202)
  - [Additional Information on API Authentication](https://support.optisigns.com#Section%203)
  - [Handling Multiple Stores or POS Locations](https://support.optisigns.com#Section%204)
  - [How to Use Post-Request Processing to Convert API Data](https://support.optisigns.com#Section%205)
- [How to Build Digital Menu Boards in Designer with OptiSync](https://support.optisigns.com#Section%206)  
  - [Using DataSources and Repeaters](https://support.optisigns.com#Section%207)
  - [Element Mapping](https://support.optisigns.com#Section%208)  
    - [Adding Text Elements to Your Menu](https://support.optisigns.com#Section%209)
    - [Creating Strike Throughs and Sold Out Warnings](https://support.optisigns.com#Section%2010)
- [Pushing a Digital Menu Board to a Screen](https://support.optisigns.com#Section11)
