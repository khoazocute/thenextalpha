...
- [Creating an Entra App in Microsoft Azure](https://support.optisigns.com#Create)
- [Enable Power BI Service Admin Settings](https://support.optisigns.com#Enable)
  - [Add the Service Principal to a Workspace](https://support.optisigns.com#Add)
- [Authenticating OptiSigns via Service Principal](https://support.optisigns.com#Auth)
- [Getting Power BI onto a Screen](https://support.optisigns.com#Get)
