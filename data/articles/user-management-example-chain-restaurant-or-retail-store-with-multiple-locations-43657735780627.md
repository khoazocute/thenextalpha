...
- [Identifying the Need](https://support.optisigns.com#Identifying)
- [Folder and Screen Organization](https://support.optisigns.com#Organization)
- [Creating Teams](https://support.optisigns.com#CreatingTeams)
- [Set Up Folder-Level Security](https://support.optisigns.com#FolderLevelSecurity)
  - [Complete Folder-Level Security Example](https://support.optisigns.com#SecurityExample)
- [Branding and Enforcing Brand Guidelines (Optional)](https://support.optisigns.com#Branding)
- [Adding Users via SAML SSO, or Directly Through OptiSigns](https://support.optisigns.com#AddingUsers)
