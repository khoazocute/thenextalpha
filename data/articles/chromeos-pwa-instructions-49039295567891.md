...
- [Adding OptiSigns Player to a Google Admin Account](https://support.optisigns.com#AddingOptiSigns)
- [Adding the OptiSigns Player App as an Extension](https://support.optisigns.com#Extension)
- [Mass Provisioning ChromeOS Devices (OPTIONAL)](https://support.optisigns.com#MassProvisioning)
  - [Creating a Mass Provisioning Template on OptiSigns](https://support.optisigns.com#Creating)
  - [Adding to Extension Policy and Applying to OptiSigns Player](https://support.optisigns.com#ExtensionPolicy)
- [Adding OptiSigns Player to a Private Account](https://support.optisigns.com#PrivateAccount)
