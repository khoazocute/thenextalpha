...
- [Installing a Root Certificate on an OptiSigns Gen 3 Pro Player](https://support.optisigns.com#ProPlayer)
- [Installing a Root Certificate on a Linux/Ubuntu Device](https://support.optisigns.com#Ubuntu)
- [Installing a Root Certificate on a Windows Device](https://support.optisigns.com#Windows)
  - [Open the Microsoft Management Console (MMC)](https://support.optisigns.com#MMC)
  - [Add the Certificates Snap-in](https://support.optisigns.com#Snap-In)
  - [Import the Certificate](https://support.optisigns.com#Import)
  - [Verify the Installation](https://support.optisigns.com#Verify)
  - [Command Line Installation](https://support.optisigns.com#Command1)
- [Installing a Root Certificate on a MacOS Device](https://support.optisigns.com#MacOS)  
  - [Install Certificate](https://support.optisigns.com#Install)
  - [Command Line Installation](https://support.optisigns.com#Command2)
- [Installing a Root Certificate on Chrome-Based Web Browsers](https://support.optisigns.com#Chrome)
- [Setting Up an Internal Website for Use on OptiSigns Using the Website App](https://support.optisigns.com#InternalWebsite)
  - [Using Web Scripting to Bypass Logins](https://support.optisigns.com#WebScripting)
