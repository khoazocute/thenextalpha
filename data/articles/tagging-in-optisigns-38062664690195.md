...
- [Screen Tagging](https://support.optisigns.com#ScreenTagging)
  - [Pushing to Multiple Screens](https://support.optisigns.com#Pushing)
  - [Tagging for Remote Commands](https://support.optisigns.com#RemoteCommands)
- [Asset Tagging](https://support.optisigns.com#AssetTagging)
  - [Single Asset Tagging](https://support.optisigns.com#SingleAsset)
  - [Multi Asset Tagging](https://support.optisigns.com#MultiAsset)
- [Tagging Use Examples](https://support.optisigns.com#UseExamples)
  - [Asset Tagging for Organization](https://support.optisigns.com#Organization)
  - [Screen Tagging for Simultaneous Updates](https://support.optisigns.com#SimultaneousUpdating)
...
You can add as many different tags as you want to a screen. Please note that these screen tags are separate from those tags you may have applied to your assets. For more information on tagging assets, see the [**Asset Tagging**](https://support.optisigns.com#AssetTagging) section later in this article.
