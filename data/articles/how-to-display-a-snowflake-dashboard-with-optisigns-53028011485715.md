...
- [Creating a Snowflake App](https://support.optisigns.com#CreateanApp)
- [Deploying a Snowflake App](https://support.optisigns.com#Deploying)
- [Frequently Asked Questions](https://support.optisigns.com#FAQs)
...
- **Sign In**
  - **Master Password -** When checked, this will prompt you to enter a Master Password for use on OptiSigns.
    - While your password is encrypted with OptiSigns, this adds an extra layer of encryption. This way, even OptiSigns cannot decrypt your password. More detail in [the FAQ section](https://support.optisigns.com#Encryption).
  ...
  - **Secret 2FA** - This is the Secret Key. Only needed if your login requires 2FA. We go over how to obtain this in [the FAQ section](https://support.optisigns.com#2FA).
